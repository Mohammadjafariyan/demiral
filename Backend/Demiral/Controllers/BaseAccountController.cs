...
namespace Demiral.Controllers
{
    ...
    public abstract class BaseAccountController : Controller
    {
        ...
        public virtual ActionResult Login(string returnUrl)
        {
            ...
            {
                return RedirectBasedOnUser(returnUrl);
            }
            return View();
        }

        private ActionResult RedirectBasedOnUser(string returnUrl)
        {
            if (User.IsInRole("Customer"))
                return RedirectToAction("index", "Buyer/BHome");
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public virtual async Task<ActionResult> Register([Bind(Include = "Email,Password,ConfirmPassword")] RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectBasedOnUser(null);
